...
public class VerDetalle3 extends Activity
{	
    ...
    public void onCreate(Bundle savedInstanceState) 
	{
        ...
        setContentView(R.layout.activity_ver_detalle3);
         
        lstClientes = (ListView)findViewById(R.id.lstDetalle3); 
        txtFiltro = (EditText)findViewById(R.id.txtFilt3);
        ...
        dadb = new DatosAplicacion(VerDetalle3.this,"PrincipalDB", null, 1);
        ...
        adapter = new AdaptadorTitulares(VerDetalle3.this);
    ...
    {
    	Intent intent=new Intent(VerDetalle3.this,VerCliente3.class);
