...
public class Ver_Detalle extends Activity
{
    ...
    public void onCreate(Bundle savedInstanceState) 
	{
        ...
        dadb = new DatosAplicacion(Ver_Detalle.this,"PrincipalDB", null, 1);
        ...
        adapter = new AdaptadorTitulares(Ver_Detalle.this);
    ...
    {
    	Intent intent=new Intent(Ver_Detalle.this,Ver_Cliente.class);
